...
CMPE 540 Project / Splendor
---------------------------

0. First Things First

I was unable to upload whole project because of size limit. The following zip files includes 'www' folder, which should be put on the same directory with 'webplay.pl' file.

	https://www.dropbox.com/s/ik02cplt2r9flb4/2000800182_www.zip?dl=0
...
4. Player and Framework Interaction
